...
SECRET_KEY = 'django-insecure-0c$66^n&e^x-m9zc2=9&0$2s*njlgi$ap@$jbcrqxoli&47cjq'
...
DATABASES = {
    'default': {
        ...
        'NAME': 'MOTOREPDB',  # Nombre de la base de datos
...
REST_FRAMEWORK = {
    ...
    #Bloquear el acceso a todos los modúlos, requiere el tokens
